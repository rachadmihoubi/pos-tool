...
5's hub static page (build-order steps 1-3) is now built and tested per
`docs/superpowers/plans/2026-08-27-component5-hub-page.md` — not yet
deployed live (that plan's Task 4 needs the user's go-ahead first, since
it changes the real Cloudflare account). Next build-order step after that:
